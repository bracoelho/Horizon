...
1. What deterministic methods are used by the Agents to leave a trail auditable and not possible to tamper with
2. Are we measuring reliability with the other agents present?
3. Do we have a deterministic report and escalation for the hard cases on their own (never inside an average, because that is where this failure hides)?
4. Do we have a routine with our own staff scoring previous cases to check calibration needs?
    
**Where I would be wrong.** I have seen and dealt myself with systems with AI Agents feeling peer pressure from other Agents. I could be wrong about how your AI Agentic system is exposed to what the paper reports and the impact it can create.
