...
**What to do.** Safety evaluations must include the quantized variant risks before deployments. The question to ask: 'For every model we've certified, how do we ensure we keep updating the safety test results, ours and our models providers? How we stress test ourselves and our providers agains these types of insights.

**Where I would be wrong.** Adding costs and delay by being watchful of these kinds of insights is what keeps companies in the frontier of security, however adds costs and delay. This articles is not enough to signal where one should invest time on it specifically.
